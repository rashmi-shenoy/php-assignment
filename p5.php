...
<form method="post">
Enter the num1:<input type="text" name="num1" value="" /> <br/> <br/>
Enter the num2:<input type="text" name="num2" value="" /> <br/> <br/>
Enter the choice:<input type="text" name="option" value="" /> <br/> <br/>
